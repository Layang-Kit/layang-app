...
## 📖 Alternatif: Workers Binding (Production)

Untuk production di Cloudflare Pages, binding lebih aman:
...
Tapi untuk saat ini, pakai S3 API dengan Access Key sudah cukup.
