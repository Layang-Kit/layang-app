...
│  │   │  - Render UI                                      │  │   │
│  │   │  - Call API endpoints for client-side actions     │  │   │
│  │   └──────────────────────────────────────────────────┘  │   │
│  │                                                          │   │
│  └─────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────┘
...
Data Flow:
1. Server: hooks.server.ts → inject DB + Auth
2. Server: +page.server.ts load() → query DB
3. Server: Render HTML with data
4. Browser: Hydrate → Interactive
5. Browser: API calls → +server.ts endpoints
```
