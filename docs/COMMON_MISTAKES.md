...
### 4. Raw SQL Tanpa Escaping

**❌ Kesalahan (SQL Injection):**
```typescript
...
### 5. Check Auth di Client-Side Saja
...
### 6. Simpan Password di LocalStorage
...
**✅ Solusi:**
- Gunakan HTTP-only cookies (sudah default)
- Server handle session
- Client tidak perlu tahu password

---

### 7. Lupa Validate Input
...
### 8. Dynamic Type di Input dengan bind:value
...
### 13. Tidak Pakai Key di Each Block
...
### 14. Heavy Computation di Reactive Statement
...
### 17. Lupa Set Environment Variables di Production
...
### 18. Mix Local dan Remote Database

**❌ Kesalahan:**
```bash
# Development pakai remote D1 (bikin bill tinggi!)
# Production pakai local (tidak ada data!)
```

**✅ Solusi:**
```toml
# wrangler.toml
preview_database_id = "DB"  # Local untuk dev
database_id = "xxx-xxx"     # Remote untuk production
```
...
### 20. Test Pakai Production Database

**❌ Kesalahan:**
```bash
# Test menghapus data production!
npm run test
```
